<div style="text-align: center; ">
    <div class="btn-group">
      ...
      <div class="dropdown-menu">
       ...
       <a href="#" style="color: black;" data-toggle="tooltip" row-id="{{ $model->id }}" data-id={{ $model->unit }} data-id={{ $model->unit }} data-placement="top" data-period="" title="Void" class="dropdown-item voidUnit"> <i class="fa fa-trash"></i> Void</a>
      ...
      <a href="#" data-toggle="tooltip" style="color: black;" row-id="{{ $model->id }}" data-id={{ $model->unit }} data-placement="top" title="Log" class="dropdown-item logUnit"> <i class="fa fa-share"></i> Log</a>
