<div style="text-align: center; ">
    <div class="btn-group">
      ...
      <div class="dropdown-menu">
       ...
       <a href="#" style="color: black;" data-toggle="tooltip" row-id="{{ $model->id_tipe }}" data-id={{ $model->tipe_barang }} data-id={{ $model->tipe_barang }} data-placement="top" data-period="" title="Void" class="dropdown-item void_tipe"> <i class="fa fa-trash"></i> Void</a>
      ...
      <a href="#" data-toggle="tooltip" style="color: black;" row-id="{{ $model->id_tipe }}" data-id={{ $model->tipe_barang }} data-placement="top" title="Log" class="dropdown-item log_tipe"> <i class="fa fa-share"></i> Log</a>
