<div class="modal fade bd-example-modal-lg addCreate" data-backdrop="static" data-keyboard="false"
    style="z-index: 1041" tabindex="-1" id="addCreate" role="dialog">
            ...
            <div class="row">
                <div class="col">
                        ...
                        <form id="form-ip" method="post" action="javascript:void(0)">
                            ...
                            <div class="form-row">
                                <div class="col-4 mb-4">
                                    <div class="form-group">
                                        <label>NIK</label>
                                        <input type="number" name="nik" id="nik" class="form-control" onchange="checkEmp()" placeholder="NIK">
                                    </div>
                                </div>
                                <div class="col-4 mb-4">
                                    <div class="form-group">
                                ...
                                <div class="col-4 mb-4">
                                    <div class="form-group">
                                        <label>Bagian</label>
                                        <input type="text" name="bagian" id="bagian" class="form-control" placeholder="Bagian" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" data-toggle="tooltip"  data-placement="top" title="Tambah Barang" class="btn btn-success" id="addRow"><i class="fa fa-plus"></i> Tambah Barang</button>
                        <button type="button" id="stin_trans" class="btn btn-info savePermBarang"><i class="fa fa-check"></i> Save</button>
                            <button type="button" onclick="clear_value_create_page()" class="btn btn-secondary " data-dismiss="modal">Close</button>
